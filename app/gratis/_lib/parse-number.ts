 ...
 *
 * A local duplicate of app/rapport/nieuw/_lib/parse-number.ts - same
 * reasoning as this route's fields.tsx: the free indication is a
 * deliberately separate flow from the paid wizard.
 *
