...
/**
 * Sign-in page (fase 4 stap 3) - the same structure as signup/page.tsx
 * (that page's own docstring explains the account-gates-the-wizard
 * redirect target and why this is a client component).
 */
