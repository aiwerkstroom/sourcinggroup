...
/**
 * Sign-in form (fase 4 stap 3) - the same structure as
 * signup/signup-form.tsx (that file's own docstring explains the
 * account-gates-the-wizard redirect target and why this is a client
 * component). Split out from page.tsx (the live Auth swap task) so
 * page.tsx can stay a Server Component - see page.tsx's own docstring
    ...
    <div className="mx-auto min-h-screen max-w-5xl px-4 py-10 md:px-8">
      <div className="mx-auto max-w-md">
        <header className="mb-8">
          <p className="text-text-faint text-xs tracking-widest uppercase">Inloggen</p>
          <h1 className="mt-1 text-xl font-semibold">Welkom terug</h1>
        </header>
