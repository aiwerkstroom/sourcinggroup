...
/**
 * Sign-up page (fase 4 stap 3). Client component - useAuth() needs the
 * AuthProvider React context, which only exists client-side (app/layout.tsx
 * wraps the whole app in it).
 *
